...
const PAGAMENTOS_CONFIG = {
  ...
  STATUS: [
    ...
    { id: 'EXCLUIDO', label: 'EXCLUÍDO', group: 'excluido' }
  ],
  ...
  UNIDADES: [
    ...
    { id: 'parnamirim-matriz-rn', nome: 'Parnamirim Matriz RN' },
    { id: 'sape', nome: 'Sapé' },
    { id: 'pombal', nome: 'Pombal' },
    { id: 'sao-bento', nome: 'São Bento' },
    { id: 'beira-rio', nome: 'Beira Rio' }
  ],

  PAGES: { index: 'index.html', analise: 'analise.html', financeiro: 'financeiro.html', gerentes: 'gerentes.html', vendas: 'vendas.html', faturamento: 'faturamento.html' }
};
