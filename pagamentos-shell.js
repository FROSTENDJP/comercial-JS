function renderPagSidebar(activePage) {
  ...
  if (activePage === 'financeiro') {
    ...
    `;
  } else if (activePage === 'faturamento') {
    navItems = `
      <div class="sb-section-lbl">CONFIRMAÇÃO DE PAGAMENTOS</div>
      <a href="${p.faturamento}" class="nav-item nav-item-link active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 012-2h4a2 2 0 012 2v2"/></svg><span>Faturamento</span></a>
    `;
  }
